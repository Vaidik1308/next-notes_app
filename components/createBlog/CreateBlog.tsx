...
const CreateBlog =  () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='w-[90%] mx-auto my-8 text-black h-fit' >
        <input 
            type="text" 
        ...
        <button type='submit' className='bg-green-800 p-2 text-white flex items-center justify-center gap-1.5 rounded-lg'>
            Publish
            <Send size={16}/>
        </button>
    </form>
