...
const LogInSignIn = (props: Props) => {
  return (
    <section className="text-black flex justify-center items-center min-h-screen flex-col bg-[#864AF9]">
      <div className="text-[30px] font-bold w-full flex justify-start pl-12">
        <Link
          href={".."}
          className="bg-white shadow-lg w-fit p-2 rounded-[50%] text-red-500"
        >
          <BsArrowLeft />
        </Link>
      </div>
      <div className="bg-[#864AF9] shadow-2xl text-white w-[95%] sm:w-[30%] h-[70vh] flex gap-8 flex-col justify-center items-center  py-4 rounded-lg">
        <h1 className="text-[35px] text-[#332941] font-bold flex justify-center">
          Login
        </h1>
        ...
        <div className="flex sm:flex-row flex-col items-center sm:justify-center gap-2">
          <button
            ...
            className=" h-[5vh] text-[18px] font-semibold flex items-center gap-2 bg-white text-black px-8 py-1 rounded-md"
          >
            <span>
              <FcGoogle />
            </span>
          ...
          <Link
            href={"/sign-up"}
            className="h-[5vh] flex items-center gap-2 bg-white text-black px-9 py-1 rounded-md font-semibold"
          >
            SignUp
          </Link>
        </div>
